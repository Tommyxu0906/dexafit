...
export const PROFESSION_LABELS: Record<ProfessionType, string> = {
  ...
  LSMHC: "Licensed Supervised Mental Health Counselor (LSMHC)",
  LMFT: "Licensed Marriage & Family Therapist (LMFT)",
  LICSW: "Licensed Independent Clinical Social Worker (LICSW)",
  LCSW: "Licensed Certified Social Worker (LCSW)",
